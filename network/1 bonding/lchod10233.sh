...
nmcli con add type vlan con-name cnaddr dev bond0 id 3900 ip4 172.254.1.4/24
nmcli con add type vlan con-name pnaddr dev bond0 id 3901 ip4 172.254.2.4/24
...
nmcli con modify bond1 ipv4.address 10.156.10.233/24 ipv4.gateway 10.156.10.1 ipv4.method manual
