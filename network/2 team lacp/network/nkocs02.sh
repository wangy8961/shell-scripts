...
sleep 3
# Ceph Cluster Network
./nikoyo_configure_ip.sh --connection cnaddr --bootproto static --address 172.16.5.2 --netmask 24
# Ceph Public Network
./nikoyo_configure_ip.sh --connection pnaddr --bootproto static --address 172.16.6.2 --netmask 24
# 文件存储 RIP
./nikoyo_configure_ip.sh --connection nasaddr --bootproto static --address 192.168.40.12 --netmask 24 --gateway 192.168.40.25 --dns 192.168.0.1
# 对象存储 RIP
./nikoyo_configure_ip.sh --connection s3addr --bootproto static --address 172.18.0.12 --netmask 24
