...
sleep 3
# Ceph Cluster Network
./nikoyo_configure_ip.sh --connection cnaddr --bootproto static --address 172.16.5.3 --netmask 24
# Ceph Public Network
./nikoyo_configure_ip.sh --connection pnaddr --bootproto static --address 172.16.6.3 --netmask 24
# 文件存储 DIP
./nikoyo_configure_ip.sh --connection nasaddr --bootproto static --address 192.168.40.8 --netmask 24 --gateway 192.168.40.25 --dns 192.168.0.1
# 对象存储 DIP
./nikoyo_configure_ip.sh --connection s3addr --bootproto static --address 172.18.0.8 --netmask 24
# iSCSI 服务IP
./nikoyo_configure_ip.sh --connection iscsiaddr --bootproto static --address 172.16.7.1 --netmask 24
