...
# Description: dd工具测试Ceph读写性能
# @Author: wangy
# @Date:   2016-12-21 16:41:42
# @Last Modified by:   wangy
# @Last Modified time: 2017-05-04 15:37:02
...
Usage:
    ...
    Please run such as './dd_ceph_benchmark.sh --device_type iSCSI --device /dev/sdb --readwrite "write read randwrite" --size 10G --bs_arr "4k 8k 16k 64k 256k 512k 1M 4M"'
